    ...
    <div className="bg-gray-950 min-h-screen">
      ...
      {!hasWebinars ? (
        ...
        <section className="mx-auto max-w-md px-4 pb-24 sm:px-6 lg:px-8">
          <FadeIn delay={0.3}>
            <div id="notify" className="rounded-2xl border border-white/5 bg-gray-900 p-8">
        ...
        <>
          <div className="mx-auto max-w-6xl px-4 pb-16 sm:px-6 lg:px-8 space-y-16">
          ...
          {/* ── Always-visible Get Notified section ── */}
          <section id="notify" className="border-t border-white/5 bg-gray-900/50">
            <div className="mx-auto max-w-md px-4 py-16 sm:px-6 lg:px-8">
              <FadeIn>
                <div className="text-center mb-8">
                  <p className="text-xs font-semibold uppercase tracking-widest text-blue-400 mb-3">Stay in the loop</p>
                  <h2 className="text-2xl font-bold text-white">Get notified first</h2>
                  <p className="mt-3 text-gray-400 text-sm leading-relaxed">
                    Drop your details and we&apos;ll email you the moment a new session opens for registration.
                  </p>
                </div>
                <WebinarNotifyForm />
              </FadeIn>
